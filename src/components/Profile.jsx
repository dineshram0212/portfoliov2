...
const Profile = () => {
  return (
    <div
      className="flex items-center justify-center w-screen h-screen bg-white z-10 bg-cover overflow-hidden"
      id="profile"
    >
      <div className="flex relative flex-col w-[1880px] h-[950px] bg-gradbg bg-cover rounded-3xl overflow-hidden">
        <div>
          {/* <img
            className="z-0 absolute -left-20 -top-20 w-[400px]"
            src={bubble}
          /> */}
        </div>
        <div className="flex h-[18%] font-roxborough text-4xl items-center justify-between p-10">
          <div className="text-white">Profile</div>
          <div className="flex flex-col gap-2 h-max w-max text-right text-xl text-white">
        ...
        <div className="flex h-[80%] justify-center p-10 gap-10">
          <div className="group relative flex flex-col w-2/5 rounded-3xl p-10 pt-10 shadow-lg overflow-hidden">
            ...
            <div className="flex flex-col gap-3 relative z-10">
              ...
              <div className="flex flex-col gap-5">
                <div className="font-roxborough text-4xl">
                ...
                <div className="flex flex-col gap-5">
                  <div className="flex flex-col font-lora gap-2">
                    <div className="flex gap-2 text-xl items-baseline">
                      ...
                      <div className="text-lg"> October 2022</div>
                    </div>
                    <div className="flex">
                  ...
                  <div className="flex flex-col font-lora gap-2">
                    <div className="flex gap-2 text-xl items-baseline">
                      ...
                      <div className="text-lg"> July 2023 to August 2024</div>
                    </div>
                    <div className="flex">
                      <ul className="list-disc list-inside">
                        <li>
                  ...
                  <div className="flex flex-col font-lora gap-2">
                    <div className="flex gap-2 text-xl items-baseline">
                      ...
                      <div className="text-lg">September 2024 till Present</div>
                    </div>
                    <div className="flex">
                      <ul className="list-disc list-inside">
                        <li>Sample</li>
          ...
          <div className="flex flex-col w-1/5 gap-10">
            <div className="group relative flex flex-col h-1/2 rounded-3xl p-5 justify-center shadow-lg overflow-hidden">
              ...
              <div className="flex flex-col gap-3 relative z-10">
                ...
                <div className="flex flex-col gap-1">
                  <div className="font-roxborough text-3xl">
                    Sri Ramakrishna Engineering College
                  </div>
                  <div className="font-lora text-xl">
                    Bachelors of Technology
                  </div>
                  <div className="font-lora text-2xl">AI and Data Science</div>
                  <div className="font-lora text-lg">2020 - 2024</div>
                  <div className="flex justify-end items-baseline gap-1">
                    <div className="text-7xl font-extrabold font-darkergrotesque">9.11</div>
            ...
            <div className="group relative flex flex-col h-1/2 rounded-3xl p-5 justify-center shadow-lg overflow-hidden">
              ...
              <div className="relative flex flex-col z-10 gap-3">
                ...
                <div className="flex flex-col font-lora text-xl">
          ...
          <div className="flex flex-col w-[26%] gap-10 justify-between">
            <div className="group relative flex flex-col rounded-3xl h-2/5 p-5 shadow-lg overflow-hidden justify-center">
              ...
              <div className="relative flex flex-col gap-3 z-10">
                ...
                <div className="grid grid-cols-2 w-max gap-x-2 text-xl font-lora font-light">
            ...
            <div className="group relative flex flex-col rounded-3xl h-1/5 p-5 shadow-lg overflow-hidden justify-center">
              ...
              <div className="flex flex-col relative gap-3 z-10">
                ...
                <div className="flex font-lora w-2/3 text-xl gap-10">
